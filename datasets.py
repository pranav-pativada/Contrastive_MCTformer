...
def build_dataset(is_train, args, gen_attn=False, use_mIOU=False):
    ...
    if args.data_set == 'VOC12':
        if use_mIOU:
            dataset = VOC12DatasetGT(img_name_list_path=args.img_list, voc12_root=args.data_path,
